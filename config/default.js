...
module.exports = {
    app: {
        ...
        commerceAPI: {
            ...
            parameters: {
                clientId: '30248456-e940-4699-ac43-ed8bcd36ed5c',
                organizationId: 'f_ecom_blbq_002',
                shortCode: 'ff28k0r8',
                siteId: 'RefArch'
            }
        },
    ...
    ssrParameters: {
        ...
        proxyConfigs: [
            {
                host: 'ff28k0r8.api.commercecloud.salesforce.com',
                path: 'api'
            },
            {
                host: 'blbq-002.dx.commercecloud.salesforce.com',
                path: 'ocapi'
            }
        ]
    }
